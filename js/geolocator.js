...
$(document).ready(function(){
  ...
  geoLocationInit();
    ...
    function searchLocationsNear(myLatLng) {
        ...
        var showallUrl = 'showall.php?lat=' + myLatLng.lat() + '&lng=' + myLatLng.lng();
        ...
        downloadUrl(searchUrl, function(data) {
            ...
            for (var i = 0; i < markerNodes.length; i++) {
                ...
                // createOption(name, city, i);
                  createMarker(latlng, name, address, city, mobile, id);
                bounds.extend(latlng);
            }
            map.fitBounds(bounds);
        });
// show all lat longitude
        downloadUrl(showallUrl, function(data) {
            var xml = parseXml(data);
            var markerNodes = xml.documentElement.getElementsByTagName("marker");
            for (var i = 0; i < markerNodes.length; i++) {
                var id = markerNodes[i].getAttribute("id");
        ...
        function createMarker(latlng, name, address, city, mobile, id) {
            var html = "<b><a href=single.php?id=" + id + ">" + name + "</a></b> <br/>" + address + "<br/ " + city + "<br/>"+ mobile;
